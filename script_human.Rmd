---
title: "PowerPuffGenes Report: Human stem cells"
authors: "FN, CV, LP"
date: 2025-04-28
...
rm(list = setdiff(ls()[!sapply(mget(ls(), .GlobalEnv), is.function)], c("P_VALUE_FILTER", "RESULTS_PATH", "PEAK_PATH", "SPECIES", "g2s", "SAMPLE_PREFIX", "GTF_PATH", "transient_genes")))
load(file.path(RESULTS_PATH, "results_counts.RData"))
load(file.path(RESULTS_PATH, "results_tpm.RData"))
...
```{r matching peaks with transient and prolonged genes RNAseq}
