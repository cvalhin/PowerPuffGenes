...
# --- Print the plot ---
print(plot_baseline)
ggsave("results/vp_baseline.png", width = 20, height = 12)
...
ggsave("results/vp_timeseries.png", width = 20, height = 12)
```

### Heatmap for all sigificant genes
```{r}
...
# Save data for heatmap plots
save(log_tpm_matrix_gene_names, sig_log_tpm_matrix, sig_log_tpm_matrix_numeric, filtered_genes_vector, file = "results/heatmaps.RData")
...
pheatmap(sig_log_tpm_matrix_numeric, 
         ...
         breaks = breaks,
         filename ="results/all_sig_genes_log_tpm.png"
)
```
...
![tpm_prolonged_genes](results/tpm_prolonged_genes.png)
...
pheatmap(prolonged_sig_genes_numeric, 
         ...
         hclustfun = custom_hclust,
         breaks = breaks,
         filename ="results/prolonged_sig_genes_log_tpm.png"
)
```

![heatmap_prolonged_genes](results/prolonged_sig_genes_log_tpm.png)
