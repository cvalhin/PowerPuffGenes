...
print(pca_plot)
ggsave("results/pca/pca_plot.png", pca_plot, width = 8, height = 6, dpi = 300)
```
...
# --- Print the plot ---
print(plot_baseline)
ggsave("results/volcano_plots/vp_baseline.png", width = 20, height = 12)
...
ggsave("results/volcano_plots/vp_timeseries.png", width = 20, height = 12)
```
...
ggsave("results/genes/lfc_prolonged_genes.png", width = 20, height = 12, dpi = 500)
```
...
ggsave("results/genes/tpm_prolonged_genes.png", width = 20, height = 12, dpi = 500)
```


### Heatmap all sig genes
```{r}
...
pheatmap(sig_log_tpm_matrix_numeric, 
         ...
         breaks = breaks,
         filename ="results/heatmap/all_sig_genes_log_tpm.png"
)
...
pheatmap(prolonged_sig_genes_numeric, 
         ...
         hclustfun = custom_hclust,
         breaks = breaks,
         filename ="results/heatmap/prolonged_sig_genes_log_tpm.png"
)
...
# --- 6. Create Circos Plot ---
# Clear any existing circos plots
png("results/circos_differential_expression.png", 
