...
##### Result: 58317 dox common peaks of the 101526 non-dox peaks overlapped (57.4%)
##### Result: 43209 peaks found in non-dox (42.6%) that were not found in dox common
##### Result: 328 unique peaks in dox (0.3%) and not present in non-dox
...
##### Result: 96359 dox union peaks of the 101526 non-dox common peaks (94.9%)
##### Result: 5167 peaks found in non-dox (5%) that were not found in dox union
##### Result: 26884 union peaks in dox (22%) and not present in non-dox

# TODO: ask which human genome annotation (version?, /scratch/Shares/rinnclass/MASTER_CLASS/DATA/genomes/Homo_sapiens/Gencode)
