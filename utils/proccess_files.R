...
categorize_gene_expression <- function(filtered_results) {
  ...
  # Changed consistently from 12h through all time points
  change_at_12_to_end <- Reduce(intersect, list(change_at_12, change_at_24, change_at_48))
  # Changed consistently from 24h, excluding those already in 12-to-end group
  ...
  # Changed only at 48h, excluding those in previous groups
